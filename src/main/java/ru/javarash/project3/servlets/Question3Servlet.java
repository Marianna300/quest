...
@WebServlet(name = "Question3Servlet", value = Go.QUESTION3)
public class Question3Servlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        answerArrayList.add(Answer.builder()
                ...
                .sectionAnswer("Рассказать правду о себе.")
                .build());
        answerArrayList.add(Answer.builder()
                .id(String.valueOf(id))
                .sectionAnswer("Солгать о себе.")
                .build());

        question = Question.builder()
                .section("Вопрос3")
                .sectionStory("Ты поднялся на мостик.")
                .sectionQuestion("Ты кто?")
