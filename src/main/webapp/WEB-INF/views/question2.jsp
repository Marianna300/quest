...
<head>
    ...
    <title>${requestScope.question.section}</title>
</head>
...
<div class="w3-container w3-padding">
    <div class="w3-card-4">
        <div class="w3-container w3-center w3-light-blue">
            <p></p>
            <h1>${requestScope.question.sectionStory}</h1>
        </div>
        <p></p>
        <div class="w3-container w3-left-align">
            <form method="post">
                <div>
                    <h2>${requestScope.question.sectionQuestion}</h2>
                </div>
                <ul>
                    <c:forEach var="answer" items="${requestScope.question.answers}">
                        <c:if test="${answer.id=='0'}">
                            <div>
                                ...
                                <label for="answer${answer.id}">${answer.sectionAnswer}</label>
                            </div>
                        </c:if>
                        <p></p>
                        <c:if test="${answer.id!='0'}">
